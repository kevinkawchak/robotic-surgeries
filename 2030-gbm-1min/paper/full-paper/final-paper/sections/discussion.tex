...
\toprule
\textbf{Dimension} & \textbf{Baseline 4-8 h} & \textbf{60 s target} & \textbf{Rel. improved} & \textbf{Source} \\
\midrule
...
Composite (mean) & 70.35 (human) & 88.53 (robot) & +25.8 percent & comparison.json \\
\bottomrule
\end{tabular}
\end{table}
...
opportunistic extension of the FDA April 2026 Real-Time Clinical
...
\begin{tabular}{>{\raggedright\arraybackslash}p{0.9cm}
