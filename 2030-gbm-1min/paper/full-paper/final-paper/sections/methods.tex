...
The 2030-gbm-1min repository was generated from 12 instruction files at
...
README.md, commit_01_overview_1min.md, commit_02_sensors_1min.md,
commit_03_xyz_4arm.md, commit_04_iterations_1min.md, 
commit_05_competition_1min.md, file_size_pyramid_1min.md, glioblastoma_context_1min.md, multi_arm_coordination.md, robot_specification_neurospeed.md
(2030 Medtronic NeuroSpeed 1.0 7-DOF DH parameters and per-arm tool
assignment), sensor_specification_10khz.md, and zenodo_archive_protocol.md. The entire kevinkawchak/robotic-surgeries
...
The repository is designed for Linux (Ubuntu 22.04 LTS or later),
MacOS (Apple M3 Ultra or Intel), and Windows 11 with
...
Claude Code (CLI/web/IDE) & managed runtime & varies & cloud, local backend \\
\bottomrule
\end{tabular}
\end{table}
