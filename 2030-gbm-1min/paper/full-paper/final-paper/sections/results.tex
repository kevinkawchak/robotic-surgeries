...
This phase produced 12 Markdown
files at physical-ai-oncology-trials/competitions/instructions/one_minute_variant/
...
\begin{table}[H]
\centering
\caption{Per-file inventory of the 12 1-minute variant
...
sample table at robotic-surgeries/2030-gbm-1min/outputs/sensors/sensor_sample_4arm.csv
