...
Max in approximately 6 hours of compute. The 7 commit family files
...
\centering
\begin{tabular}{>{\raggedright\arraybackslash}p{3.0cm} >{\raggedright\arraybackslash}p{1.6cm} >{\raggedright\arraybackslash}p{3.0cm} >{\raggedright\arraybackslash}p{6.4cm}}
\toprule
...
The 1001 record JSONL sample at
...
four phase workflow. It captures the Phase 5 first 100 ms slice
...
field constrained by the three schemas in
...
seed contract at root seed 20260513 in
\texttt{2030-pdac-1min/paper/codegen/config/iterations.yaml}. The
6 component frozen composite breakdown at
...
The iteration analysis notebook summary at
\texttt{2030-pdac-1min/paper/execution/notebooks/iteration_analysis_summary.txt}
...
The Daraxonrasib trajectory and advisory output at
...
advisory distribution at \texttt{advisory_distribution.txt}. The
...
headline numbers are T 0 serum 0.45 ng/mL across all 32 iterations
(below the 0.5 ng/mL trough threshold), and the postoperative
restart advisory distribution is T+7d in 29 of 32 iterations,
T+14d in 3 of 32, and T+21d in 0 of 32. The FDA SaMD framing
