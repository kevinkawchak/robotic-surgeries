...
from \texttt{inputs/\pfb patient-\pfb priority-\pfb physical-\pfb ai.zip} and cite
...
\texttt{inputs/\pfb phase-\pfb 1-\pfb trial-\pfb protocol.zip}, sections \texttt{sec-\pfb 00-\pfb compliance},
\texttt{sec-\pfb 04-\pfb design}, and \texttt{sec-\pfb 06-\pfb intervention}.}
...
\texttt{diagrams-\pfb python/\pfb README.md}, and \texttt{graphviz/README.md}. State that
...
\node[mmin] (b) at (0,-2.2) {\ttfamily\tiny Source\\ mermaid/\\ fig-\pfb 01-\pfb seven-\pfb commitments.md};
\draw[mmedge] (a) -- (b);
\end{pafig}
\vspace{-0.7cm}
...
specified in \texttt{mermaid/\pfb fig-\pfb 01-\pfb seven-\pfb commitments.md}, following the TikZ
...
\node[gvbox] (b) at (0,-2.0) {\ttfamily\tiny Source\\ graphviz/\\ fig-\pfb 02-\pfb accountability-\pfb dag.dot};
\draw[gvedge] (a) -- (b);
\end{pafig}
\vspace{-0.7cm}
...
in \texttt{graphviz/\pfb fig-\pfb 02-\pfb accountability-\pfb dag.dot}. Preserve the stated
