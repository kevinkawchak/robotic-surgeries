...
\texttt{research/\pfb research-\pfb a.md} and \texttt{research/\pfb research-\pfb b.md}. Six concern
...
\node[d2box] (b) at (0,-1.8) {\ttfamily\tiny Source\\ d2/\\ fig-\pfb 05-\pfb concern-\pfb families.d2};
\draw[d2edge] (a) -- (b);
\end{pafig}
\vspace{-0.7cm}
...
figure from \texttt{d2/\pfb fig-\pfb 05-\pfb concern-\pfb families.d2}. Six \texttt{d2cont}
...
\node[gvbox] (b) at (0,-2.0) {\ttfamily\tiny Source\\ graphviz/\\ fig-\pfb 06-\pfb concern-\pfb to-\pfb clause.dot};
\draw[gvedge] (a) -- (b);
\end{pafig}
\vspace{-0.7cm}
...
map from \texttt{graphviz/\pfb fig-\pfb 06-\pfb concern-\pfb to-\pfb clause.dot}. Twenty-one concern
...
\node[mmin] (b) at (0,-2.0) {\ttfamily\tiny Source\\ mermaid/\\ fig-\pfb 07-\pfb concern-\pfb quadrant.md};
\draw[mmedge] (a) -- (b);
\end{pafig}
\vspace{-0.7cm}
...
\texttt{mermaid/\pfb fig-\pfb 07-\pfb concern-\pfb quadrant.md}. Fill the four quadrant fields
...
\node[umlbox] (b) at (0,-1.9) {\ttfamily\tiny Source\\ plantuml/\\ fig-\pfb 08-\pfb patient-\pfb actor-\pfb usecase.puml};
\draw[umlarrow] (a) -- (b);
\end{pafig}
\vspace{-0.7cm}
...
from \texttt{plantuml/\pfb fig-\pfb 08-\pfb patient-\pfb actor-\pfb usecase.puml}. Participant actor at
...
\texttt{diagrams-\pfb python/\pfb fig\_\pfb 09\_\pfb concern\_\pfb locations.py} and its
...
\node[dglabel,anchor=north] at (0,-1.6) {\ttfamily\tiny Source\\ diagrams-python/\\ fig\_\pfb 09\_\pfb concern\_\pfb locations.py};
\end{pafig}
\vspace{-0.7cm}
...
clustered map from \texttt{diagrams-\pfb python/\pfb fig\_\pfb 09\_\pfb concern\_\pfb locations.py}. Four
