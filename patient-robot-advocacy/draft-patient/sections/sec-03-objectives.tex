...
\texttt{sections/\pfb sec-\pfb 03-\pfb objectives.tex}, and restate each as a question rather
...
\node[mmin] (b) at (0,-2.0) {\ttfamily\tiny Source\\ mermaid/\\ fig-\pfb 10-\pfb endpoint-\pfb meaning.md};
\draw[mmedge] (a) -- (b);
\end{pafig}
\vspace{-0.7cm}
...
flowchart from \texttt{mermaid/\pfb fig-\pfb 10-\pfb endpoint-\pfb meaning.md}. Ranks at
...
\texttt{inputs/\pfb phase-\pfb 1-\pfb trial-\pfb protocol.zip}, \texttt{sections/\pfb sec-\pfb 03-\pfb objectives.tex}.
...
\node[d2box] (b) at (0,-1.8) {\ttfamily\tiny Source\\ d2/\\ fig-\pfb 11-\pfb endpoint-\pfb registry.d2};
\draw[d2edge] (a) -- (b);
\end{pafig}
\vspace{-0.7cm}
...
\texttt{d2/\pfb fig-\pfb 11-\pfb endpoint-\pfb registry.d2}. Five \texttt{d2sql} nodes at the
