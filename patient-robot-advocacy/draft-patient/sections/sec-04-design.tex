...
Adapt from \texttt{inputs/phase-1-trial-protocol.zip},
\texttt{sections/sec-04-design.tex}.}

\begin{pafig}[plantuml-type: state machine, @startuml]
\node[umlkey] (a) at (0,0) {Figure 12 slot\\participant state machine};
\node[umlbox] (b) at (0,-1.9) {Source:\\plantuml/fig-12-participant-state-machine.puml};
\draw[umlarrow] (a) -- (b);
\end{pafig}
\vspace{-0.7cm}
...
\texttt{plantuml/fig-12-participant-state-machine.puml}. Single column of
...
\node[gvbox] (b) at (0,-2.0) {Source:\\graphviz/fig-13-escalation-decision-tree.dot};
\draw[gvedge] (a) -- (b);
\end{pafig}
\vspace{-0.7cm}
...
\texttt{graphviz/fig-13-escalation-decision-tree.dot}. Four ranks at
...
\texttt{sections/sec-04-design.tex} and \texttt{sections/sec-06-intervention.tex}.
...
triggers from \texttt{inputs/phase-1-trial-protocol.zip},
\texttt{sections/sec-04-design.tex} \S4.6. Include the device-specific triggers,
