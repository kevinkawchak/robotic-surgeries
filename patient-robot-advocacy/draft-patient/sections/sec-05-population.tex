...
\texttt{sections/\pfb sec-\pfb 05-\pfb population.tex} \S5.1 and \S5.2.}

\begin{pafig}[mermaid-type: flowchart TD, two decision columns]
\node[mmgoal] (a) at (0,0) {Figure 14 slot\\two-way eligibility gate};
\node[mmin] (b) at (0,-2.0) {\ttfamily\tiny Source\\ mermaid/\\ fig-\pfb 14-\pfb eligibility-\pfb self-\pfb selection.md};
\draw[mmedge] (a) -- (b);
\end{pafig}
\vspace{-0.7cm}
...
flowchart from \texttt{mermaid/\pfb fig-\pfb 14-\pfb eligibility-\pfb self-\pfb selection.md}. Two
...
\texttt{inputs/\pfb phase-\pfb 1-\pfb trial-\pfb protocol.zip},
\texttt{sections/\pfb sec-\pfb 05-\pfb population.tex} \S5.1 and \S5.2. Keep the second column
...
\node[umlbox] (b) at (0,-1.9) {\ttfamily\tiny Source\\ plantuml/\\ fig-\pfb 15-\pfb booking-\pfb sponsor-\pfb response.puml};
\draw[umlarrow] (a) -- (b);
\end{pafig}
\vspace{-0.7cm}
...
\texttt{plantuml/\pfb fig-\pfb 15-\pfb booking-\pfb sponsor-\pfb response.puml}. Five lifelines at
...
\node[d2box] (b) at (0,-1.8) {\ttfamily\tiny Source\\ d2/\\ fig-\pfb 16-\pfb five-\pfb choices-\pfb layers.d2};
\draw[d2edge] (a) -- (b);
\end{pafig}
\vspace{-0.7cm}
...
\texttt{d2/\pfb fig-\pfb 16-\pfb five-\pfb choices-\pfb layers.d2}. Five \texttt{d2step} panels stacked
