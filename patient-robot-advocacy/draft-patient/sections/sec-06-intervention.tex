...
\node[dglabel,anchor=north] at (0,-1.6) {Source: diagrams-python/fig\_17\_operating\_room\_stack.py};
\end{pafig}
\vspace{-0.7cm}
...
\texttt{diagrams-python/fig\_17\_operating\_room\_stack.py}. Five
...
\node[mmin] (b) at (0,-2.0) {Source:\\mermaid/fig-19-advise-approve-execute.md};
\draw[mmedge] (a) -- (b);
\end{pafig}
\vspace{-0.7cm}
...
\texttt{mermaid/fig-19-advise-approve-execute.md}. Five \texttt{mmactor} headers
...
\node[umlbox] (b) at (0,-1.9) {Source:\\plantuml/fig-18-estop-timing-budget.puml};
\draw[umlarrow] (a) -- (b);
\end{pafig}
\vspace{-0.7cm}
...
from \texttt{plantuml/fig-18-estop-timing-budget.puml}. Five stacked 14 cm
...
\node[d2box] (b) at (0,-1.8) {Source:\\d2/fig-21-force-nofly-envelope.d2};
\draw[d2edge] (a) -- (b);
\end{pafig}
\vspace{-0.7cm}
...
\texttt{d2/fig-21-force-nofly-envelope.d2}. One outer \texttt{d2cont}, two
...
\node[gvbox] (b) at (0,-2.0) {Source:\\graphviz/fig-20-hazard-barrier-fault-tree.dot};
\draw[gvedge] (a) -- (b);
\end{pafig}
\vspace{-0.7cm}
...
\texttt{graphviz/fig-20-hazard-barrier-fault-tree.dot}. Use
