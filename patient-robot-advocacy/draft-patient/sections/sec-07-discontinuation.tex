...
data use as well. Adapt from \texttt{inputs/phase-1-trial-protocol.zip},
\texttt{sections/sec-07-discontinuation.tex}, and cite \texttt{ecfr2026part50}
...
\node[umlbox] (b) at (0,-1.9) {Source:\\plantuml/fig-22-withdrawal-activity.puml};
\draw[umlarrow] (a) -- (b);
\end{pafig}
\vspace{-0.7cm}
...
\texttt{plantuml/fig-22-withdrawal-activity.puml}. Three vertical
...
\node[mmin] (b) at (0,-2.0) {Source:\\mermaid/fig-23-consent-lifecycle.md};
\draw[mmedge] (a) -- (b);
\end{pafig}
\vspace{-0.7cm}
...
\texttt{mermaid/fig-23-consent-lifecycle.md}. \texttt{umlinit} at $(0,1.4)$,
...
\texttt{sections/sec-07-discontinuation.tex} \S7.2, and state that in every case
