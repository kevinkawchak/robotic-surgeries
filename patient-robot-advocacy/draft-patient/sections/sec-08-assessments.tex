...
\node[mmin] (b) at (0,-2.0) {\ttfamily\tiny Source\\ mermaid/\\ fig-\pfb 25-\pfb visit-\pfb timeline.md};
\draw[mmedge] (a) -- (b);
\end{pafig}
\vspace{-0.7cm}
...
\texttt{mermaid/\pfb fig-\pfb 25-\pfb visit-\pfb timeline.md}. A 15 cm time axis spanning September
...
\node[dglabel,anchor=north] at (0,-1.6) {\ttfamily\tiny Source\\ diagrams-python/\\ fig\_\pfb 24\_\pfb data\_\pfb pipeline.py};
\end{pafig}
\vspace{-0.7cm}
...
from \texttt{diagrams-\pfb python/\pfb fig\_\pfb 24\_\pfb data\_\pfb pipeline.py}. Four stage clusters
...
\texttt{diagrams-\pfb python/\pfb fig\_\pfb 24\_\pfb data\_\pfb pipeline.py}, converting days to years.}
...
\node[d2box] (b) at (0,-1.8) {\ttfamily\tiny Source\\ d2/\\ fig-\pfb 26-\pfb robot-\pfb instruction-\pfb cards.d2};
\draw[d2edge] (a) -- (b);
\end{pafig}
\vspace{-0.7cm}
...
\texttt{d2/\pfb fig-\pfb 26-\pfb robot-\pfb instruction-\pfb cards.d2}. Two columns by five rows of
