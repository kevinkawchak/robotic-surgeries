...
\node[mmin] (b) at (0,-2.0) {Source:\\mermaid/fig-27-reassurance-dashboard.md};
\draw[mmedge] (a) -- (b);
\end{pafig}
\vspace{-0.7cm}
...
from \texttt{mermaid/fig-27-reassurance-dashboard.md}. Five stacked panels
...
\node[gvbox] (b) at (0,-2.0) {Source:\\graphviz/fig-28-evidence-provenance.dot};
\draw[gvedge] (a) -- (b);
\end{pafig}
\vspace{-0.7cm}
...
from \texttt{graphviz/fig-28-evidence-provenance.dot}. Three ranks at
