...
\texttt{sections/\pfb sec-\pfb 12-\pfb references-\pfb backmatter.tex}, and re-scoped to an advocacy
...
\draftinstr{Add any abbreviation introduced by \texttt{full-\pfb patient} that is not
...
\texttt{github.com/\pfb kevinkawchak/\pfb robotic-\pfb surgeries/\pfb tree/\pfb main/\pfb patient-\pfb robot-\pfb advocacy}.
...
\texttt{research/\pfb research-\pfb a.md} (Gemini 3.1 Pro) and
\texttt{research/\pfb research-\pfb b.md} (ChatGPT 5.6 Thinking Extended), and state that
