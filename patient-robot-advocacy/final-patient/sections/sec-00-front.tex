...
commitment, whatever else it has done, and \S 11.6 names the escalation route
...
through consent, the Phase 0 gate, and dose assignment, to the day-30 safety window\\
and the day-90 pathology result that is reported back to them directly.}
\end{pafloat}
...
\end{pafig}
\vspace{-0.7cm}
\figcaption{Figure 2. The accountability chain drawn as a rooted directed acyclic graph with the\\
participant at the root, showing the people in the room, the bodies accountable for the\\
study, the independent reviewers, and the three obligations that point back.}
\end{pafloat}
...
obligations to inform. They are not courtesies, and \S 11.6 names the escalation
...
answered by governance or disclosure alone, and \S 3.8 names each of those five
