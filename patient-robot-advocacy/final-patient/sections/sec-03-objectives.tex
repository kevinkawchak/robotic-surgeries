...
\end{pafig}
\vspace{-0.7cm}
\figcaption{Figure 10. Each objective carried through its endpoints to the plain sentence that the\\
...
\end{pafig}
\vspace{-0.7cm}
\figcaption{Figure 11. The endpoint registry drawn as typed records with foreign keys to the analysis\\
populations and to the provenance classes, and with a plain-meaning row that no clinical\\
protocol carries but that this paper treats as a required field of the record.}
\end{pafloat}
