...
\end{pafig}
\vspace{-0.7cm}
\figcaption{Figure 30. Post-trial continuity across three time zones, during the study, the 12 months\\
after the last visit, and beyond, with the payer attached to every item and the two unsettled\\
items drawn as unsettled rather than being quietly left out of the figure.}
\end{pafloat}
