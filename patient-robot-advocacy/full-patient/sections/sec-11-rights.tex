...
Participant health data self-custody & Per-store read lists published, and your own copy available at any time, \S 9.3 and Figure 24 \\
\bottomrule
\end{tabularx}
...
\noindent\begin{tabularx}{\textwidth}{L{5.4cm} C{2.3cm} Y}
\toprule
